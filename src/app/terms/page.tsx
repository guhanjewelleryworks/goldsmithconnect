  ...
  return (
    <div className="container mx-auto max-w-4xl py-12 px-4 md:px-6">
       <Card className="shadow-lg border-primary/20">
        <CardHeader>
           <CardTitle className="text-3xl font-bold text-primary-foreground mb-4">Terms of Service</CardTitle>
        ...
        <CardContent className="prose prose-stone dark:prose-invert max-w-none text-foreground space-y-4">
            ...
            <h2 className="text-xl font-semibold text-primary-foreground">Cookies</h2>
            ...
            <h2 className="text-xl font-semibold text-primary-foreground">License</h2>
            ...
            <ul>
             ...
             <h2 className="text-xl font-semibold text-primary-foreground">User Content</h2>
            ...
            <h2 className="text-xl font-semibold text-primary-foreground">Disclaimer</h2>
